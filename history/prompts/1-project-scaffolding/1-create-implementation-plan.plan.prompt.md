...
```text
1. Decide folder structure
2. Define module boundaries
3. Create configuration files
4. Write setup and run instructions
1. Invoke Skill: python_project_scaffolder
2. Generate project structure and config files
3. Review generated output for completeness
```
